...
const GameInfo: React.FC<GameInfoProps> = ({ data }) => (
  <HelmetProvider>
    <article className="xs:my-5 md:my-10 md:p-10 min-h-[max-content] w-[full] md:rounded-3xl overflow-hidden md:shadow-soft md:dark:shadow-soft-dark sm:flex sm:flex-col sm:items-start">
      <Helmet>
